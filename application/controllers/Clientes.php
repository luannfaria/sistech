...
class Clientes extends CI_Controller {
	...
	function gerenciar(){
	    ...
	    $this->data['results'] = $this->clientes_model->get('clientes','idClientes,nomeCliente,celular,rua,numero,bairro,cidade,estado,cep','',$config['per_page'],$this->uri->segment(3));

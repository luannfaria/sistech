...
class Os_model extends CI_Model {
    ...
    function lista(){
       ...
       // $sql = "select clientes.nomeCliente,os.start, os.end, os.usuarios_id FROM os INNER JOIN clientes ON os.clientes_id = clientes.idClientes";
       // $sql ="select servicos_os.nomecliente,os.start, os.end, servicos_os.idUsuarios_os FROM os INNER JOIN servicos_os ON os.idOs = servicos_os.os_id";
        
       $sql= "SELECT concat(servicos_os.start,' ',servicos_os.horaservico_os)as data, servicos_os.nomecliente,servicos_os.idUsuarios_os, servicos.nome from servicos_os INNER JOIN servicos ON servicos.idServicos = servicos_os.servicos_id";
        $query = $this->db->query($sql);
        $array = $query->result_array();
        return $array;
    ...
    function listausuarios(){
        $query = $this->db->query('SELECT nome FROM usuarios');
    ...
    public function retorna_usuarios(){
         $sql = "SELECT idUsuarios,nome from usuarios";
        $query = $this->db->query($sql);
        $array = $query->result_array();
        return $array;

            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal" >
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="nome" style="text-transform:uppercase" type="text" name="nome" value="<?php echo $result->nome; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="login" type="text" name="login" value="<?php echo $result->login; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                        <input id="cor" type="color" name="cor" value="<?php echo $result->cor; ?>">
                        </div>
                    </div>

...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/bootstrap-datetimepicker.min" />
...
<div id="editar"class="modal hide fade">
  <div class="modal-header">
    ...
    <h3>Agenda - Número: <?php echo $result->idOs ?></h3>
  </div>
           ...
           <!-- <div class="widget-content nopadding">-->
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li  id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalhes da Agenda</a></li>
                        <li id="tabProdutos"><a href="#tab2" data-toggle="tab">Produtos</a></li>
                        <li class="active" id="tabServicos"><a href="#tab3" data-toggle="tab">Serviços</a></li>
            ...
            <div class="span4">
                <label for="">Hora</label>
                      ...
                      <input id="start" type="hidden" name="start" value="<?php echo $result->start?>"/>
                                             <input id="end" type="hidden" name="end" value="<?php echo $result->end?>"/>
...
<div class="modal-body">
    ...
    <div class="span12" style="margin-left: 0"> 
      <div class="span4" style="margin-left: 0">
        <label for="recebido">Receber?</label>

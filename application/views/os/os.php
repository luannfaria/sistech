...
<table class="table table-bordered ">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="6">Nenhuma agendamento no sistema</td>
        </tr>
    </tbody>
</table>
</div>
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    ...
    <h5 style="text-align: center">Deseja realmente excluir esse agendamento?</h5>
  </div>
   ...
   $(document).on('click', '#excluir-notificacao', function(event) {
       ...
       .done(function(data) {
           if(data.result == true){
              ...
              alert('Ocorreu um problema ao tentar excluir notificação.');
           }

                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <h3>Agendamento: <?php echo $result->idOs ?></h3>
                                        <h4><?php echo $result->hora?></h4>
                            ...
                            <div class="span12" style="padding: 1%; margin-left: 0">
                                <div class="span12 well" style="padding: 1%; margin-left: 0">
                                    ...
                                    <div class="span4">
                                        ...
                                        <!-- campos hidden passar valor do cabeçalho pedido -->
                                        ...
                                        <div class="span4">
                                            <label>Horario</label>
                                             ...
                                             <input type="text" name="horaservico_os"  class="span12 timepicker" id="horaservico_os" value="<?php echo $result->hora?>"/>
                                            
                                            <input type="hidden" name="nomeatendente" id="nomeatendente" value="<?php echo $result->nome?>"/>
                                        </div>
                                        <div class="span4">

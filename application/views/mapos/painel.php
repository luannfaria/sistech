    ...
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
          ...
          <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vAgenda')){ ?>
            <li class="bg_lg"> <a href="<?php echo base_url()?>index.php/agenda"> <i class="icon-calendar"></i> Agenda</a> </li>
        <?php } ?>
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vCliente')){ ?>
            <li class="bg_lg"> <a href="<?php echo base_url()?>index.php/clientes"> <i class="icon-group"></i> Clientes</a> </li>
        <?php } ?>
        ...
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vServico')){ ?>
            <li class="bg_lg"> <a href="<?php echo base_url()?>index.php/servicos"> <i class="icon-wrench"></i> Serviços</a> </li>
        <?php } ?>
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vLancamento')){ ?>
            <li class="bg_lg"> <a href="<?php echo base_url()?>index.php/financeiro"> <i class="icon-money"></i> Financeiro</a> </li>
        <?php } ?>
...
<div class="row" style="margin-top: 0">
    ...
    <div class="col-md-12" style="margin-left: 0">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Agendamentos em aberto</h5></div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
                        <tr>
...
<div class="row" style="margin-top: 0">
    ...
    <div class="col-md-12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Estatísticas da Agenda</h5></div>
            <div class="widget-content">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="site-stats">
                            ...
                            <li class="bg_lh"><i class="icon-tags"></i> <strong><?php echo $this->db->count_all('os');?></strong> <small>Agendamentos</small></li>
